...
Partial Class SearchProficency
    ...
    Private Sub InitializeComponent()
        ...
        Button8.Location = New Point(1180, 62)
        ...
        ' TextBox1
        ' 
        TextBox1.Location = New Point(289, 64)
        ...
        Name = "SearchProficency"
        Text = "SearchProficency"
        ResumeLayout(False)
        PerformLayout()
    End Sub
